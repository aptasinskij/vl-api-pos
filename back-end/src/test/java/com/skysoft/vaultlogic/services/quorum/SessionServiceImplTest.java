...
import com.skysoft.vaultlogic.services.cloud.SessionServiceImpl;
...
public class SessionServiceImplTest {
    ...
    static class QuorumSessionServiceTestConfiguration {
        ...
        @Bean
        public SessionServiceImpl quorumSessionService() {
            return new SessionServiceImpl(sessionRepository, applicationRepository, kioskService, kioskApplicationClient);
        }
    ...
    public void givenFailedToLaunchApplication_whenError_thanCorrect() {
        ...
        sessionServiceImpl.createSession(ZERO, "xToken");
    ...
    public void givenApplicationNotFound_whenError_thanCorrect() {
        ...
        sessionServiceImpl.createSession(applicationId, xToken);
    ...
    public void givenApplicationLaunchedKioskResolved_whenSuccess_thanCorrect() {
        ...
        Pair<String, BigInteger> stringBigIntegerPair = sessionServiceImpl.createSession(applicationId, xToken);
